...
/**
 * Simisimiconnector data helper
 */
namespace Simi\Simisimiconnector\Helper;
...
{
    /**
     * Path to store config where count of simiconnector posts per page is stored
     *
     * @var string
     */
     ...
     * @var string
     */
    const MEDIA_PATH    = 'Simisimiconnector';
    ...
    /**
     * Remove Simisimiconnector item image by image filename
     *
     ...
     * @return bool|string
     */
    public function resize(\Simi\Simisimiconnector\Model\Simisimiconnector $item, $width, $height = null)
    {
        if (!$item->getImage()) {
            return false;
        }
    ...
    public function uploadImage($scope)
    {
        ...
        if ($adapter->isUploaded($scope)) {
            ...
            if ($uploader->save($this->getBaseDir())) {
                return 'Simisimiconnector/'.$uploader->getUploadedFileName();
            }
        }
        return false;
    }
    ...
    /**
     * Return the base media directory for Simisimiconnector Item images
     *
     * @return string
     */
    ...
    /**
     * Return the Base URL for Simisimiconnector Item images
     *
     * @return string
     */
     ...
     * @return int
     */
    public function getSimisimiconnectorPerPage()
    {
