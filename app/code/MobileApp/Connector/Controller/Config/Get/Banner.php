...
class Banner extends \MobileApp\Connector\Controller\Connector
{
    /**
     *
     * @return void
    ...
    {
        $collection = $this->_objectManager->create('MobileApp\Connector\Model\ResourceModel\Banner\Collection')
