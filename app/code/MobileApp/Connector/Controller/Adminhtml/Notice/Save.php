...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function sendNotice($data) {
        ...
        $history = $this->_objectManager->create('MobileApp\Connector\Model\History');
        if(!$trans)
            $data['status'] = 0;
        else
            $data['status'] = 1;
    ...
    public function send(&$data) {
        ...
        $collectionDevice = $this->_objectManager->create('MobileApp\Connector\Model\Device')->getCollection();
        $collectionDevice2 = $this->_objectManager->create('MobileApp\Connector\Model\Device')->getCollection();
    ...
    public function sendIOS($collectionDevice, $data) {
        $helper = $this->_objectManager->get('MobileApp\Connector\Helper\Data');
    ...
    public function sendTurnAnroid($collectionDevice, $from, $to, $message){
        ...
        $api_key = $this->_objectManager->get('MobileApp\Connector\Helper\Data')->getAndroidKeyConfig();
        $headers = array(
