    ...
    public function setBuilderQuery()
    {
        ...
        if ($data['resourceid']) {
            ...
            $cmsCollection->getSelect()
                    ->join(['visibility' => $visibilityTable], 'visibility.item_id = main_table.cms_id AND visibility.content_type = '.$typeID.' AND visibility.store_view_id =' . $this->_storeManager->getStore()->getId());
