...
namespace Simi\Simiconnector\Model\Resolver234\Products\Query;

use Simi\Simiconnector\Model\Resolver234\Products\DataProvider\ProductSearch;
...
class Search
{
    ...
    public function getResult(
        ...
        $searchResults = $this->productsProvider->getList($searchCriteriaCopy, $itemsResults, $queryFields, $args);
