...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    protected function _construct()
    {
        ...
        $this->setDefaultSort('siminotification_id');
    ...
    {
        $this->addColumn('siminotification_id', [
            'header' => __('ID'),
            'index' => 'siminotification_id',
        ]);
